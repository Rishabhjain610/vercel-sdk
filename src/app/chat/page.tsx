...
//           Chat Assistant
//         </h1>
//         <div className="h-64 mb-4 p-3 bg-gray-50 border border-gray-200 rounded overflow-y-auto italic text-gray-400">
...
//               <button onClick={stop} className="mt-2 px-3 py-1 bg-red-500 text-white rounded hover:bg-red-600 transition">
//                 Stop
//               </button>
//             ) : (
